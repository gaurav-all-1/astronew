...
import com.social.java.socialapplication.jwt.JwtAuthenticationEntryPoint;
import com.social.java.socialapplication.jwt.JwtRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers(HttpMethod.GET,"/getCategory/*").permitAll()
				.antMatchers(HttpMethod.GET,"/product/getinvoices").permitAll()
		...
		.antMatchers(HttpMethod.POST,"/product/insert_invoice").permitAll()
        ...
        .antMatchers(HttpMethod.POST,"/order/guest").permitAll()
				...
				.antMatchers(HttpMethod.POST,"/order/generateinvoice/**").permitAll()
